...
// FIX: 
// - should capitalization matter? tests doesn't current but maybe should
// - fix typo in first sentence
// - clarify examples and don't return a string
...
console.log(parseDates('Mar 2nd 11:00 AM').toLocaleString());
console.log(parseDates('Today 12:37 PM').toLocaleString());
console.log(parseDates('Today 12:38 AM').toLocaleString());
console.log(parseDates('Wednesday 8:00 AM').toLocaleString());
console.log(parseDates('Tuesday 8:00 AM').toLocaleString());

const PARSED = parseDates('Apr 21st 8:00 PM');
console.log(PARSED.getDate()) // 21;
console.log(PARSED.getMonth()) // 3;
console.log(PARSED.getFullYear()) // 2017;
console.log(PARSED.getHours()) // 20;
console.log(PARSED.getMinutes()) // 0;
