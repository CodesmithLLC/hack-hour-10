...
let H = (letters) => !letters ? 'H' : 'H' + letters;
...
const pipe = (functions) => (start) => start ? start + functions.reduce((a, c) => a + c(), '') : functions.reduce((a, c) => a + c(), '');
...
const letterGenerator = (letter) => (letters) => !letters ? letter : letter + letters;
